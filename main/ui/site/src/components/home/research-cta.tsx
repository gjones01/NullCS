...
export function ResearchCta() {
  return (
    <SectionShell
      ...
      title="Inspect the current work."
      description="The repository carries the pipeline, benchmark artifacts, and model work behind the public site."
    >
      <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <Reveal>
          ...
          <h3 className="mt-4 font-display text-3xl tracking-[-0.05em] text-white">Open the technical source</h3>
          <p className="mt-4 text-sm leading-7 text-zinc-400">
            Use the repo to inspect how demos are parsed, how features are built, and how benchmark reports are generated.
          </p>
