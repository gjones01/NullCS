            ...
            <div className="grid gap-0 lg:grid-cols-[1fr_0.72fr]">
              <div className="p-8">
                <p className="max-w-2xl text-lg leading-8 text-zinc-300">
                  The project studies whether suspicious behavior can be surfaced more reliably in real demos without flattening the
                  problem into a single loud metric. Some cases are obvious. The harder ones are the lobbies where subtle
                  assistance, strange timing, and strong legitimate play start to sit uncomfortably close together.
                </p>
                <div className="mt-8 grid gap-3 sm:grid-cols-2">
                  <div className="rounded-[1.35rem] border border-white/10 bg-[#0c1018] px-4 py-3">
                    ...
                    <p className="mt-2 text-sm leading-6 text-zinc-400">Cheater, normal, and pro slices in the current CS2 training stack.</p>
                  </div>
                  <div className="rounded-[1.35rem] border border-white/10 bg-[#0c1018] px-4 py-3">
              ...
              <div className="relative min-h-[280px] border-t border-white/8 lg:min-h-full lg:border-l lg:border-t-0">
                ...
                <div className="absolute inset-x-0 bottom-0 p-5">
                  ...
                  <p className="mt-3 max-w-sm text-sm leading-6 text-zinc-300">
                    The difficult cases are the ones where the evidence has to stay readable even when suspicious behavior and strong
                    legitimate play start to overlap.
                  </p>
                </div>
              </div>
            </div>
