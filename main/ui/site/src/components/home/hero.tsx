    ...
    <section className="relative overflow-hidden border-b border-white/8">
      ...
      <div className="container relative grid gap-14 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-end lg:py-28">
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.06}>
            <h1 className="mt-7 max-w-4xl font-display text-5xl tracking-[-0.07em] text-white sm:text-6xl lg:text-7xl">
          ...
          <Reveal delay={0.12}>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400 sm:text-xl">
              NullCS is a behavioral review research project for Counter-Strike 2 demos. It is built to surface suspicious
              patterns while staying restrained on strong legitimate play, especially high-ELO and pro-level slices where false positives matter most.
            </p>
          </Reveal>
          <Reveal delay={0.18}>
            ...
            <div className="relative aspect-[4/5]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                <div className="rounded-[1.75rem] border border-white/10 bg-black/35 p-5 backdrop-blur-[2px] transition-transform duration-500 hover:-translate-y-1">
                  ...
                  <div className="mt-3 font-display text-2xl tracking-[-0.05em] text-white">Explainable ranking for the hard cases, not just the obvious ones</div>
                  <p className="mt-3 max-w-md text-sm leading-6 text-zinc-300">
                    NullCS is aimed at the harder review problem: subtle assistance, suspicious information advantage, and behavior that needs context, not just a dramatic clip.
                  </p>
                  <Link href="/about" className="mt-5 inline-flex items-center gap-2 text-sm text-white transition-opacity hover:opacity-80">
                    See the project framing
