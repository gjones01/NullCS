          ...
          <div className="mt-7 grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-lg leading-8 text-zinc-300">
                A browser-based review workflow is in development. The goal is a clean analyst-facing surface for ranked players,
                reasons, score traces, and evidence.
              </p>
              <div className="mt-8 rounded-[1.5rem] border border-white/10 bg-white/[0.03] px-5 py-4 text-sm leading-7 text-zinc-300">
                The public site is live now. The interactive review beta is still in development.
              </div>
            </div>
            ...
            <section className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(217,122,74,0.14),rgba(9,11,18,0.98))] p-8 shadow-panel">
              ...
              <h2 className="mt-6 font-display text-4xl tracking-[-0.05em] text-white">Web review is in development.</h2>
