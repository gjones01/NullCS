...
function App() {
  ...
  const banner = desktopStatus?.is_desktop
    ...
    : backendAvailable === false ? { cls: "banner-warn", title: "Desktop alpha mode", body: "Live pipeline services are not connected. You can still open the bundled sample review or import a local review bundle." }
